...
void *tree_sitter_luax_external_scanner_create() { return NULL; }
void tree_sitter_luax_external_scanner_destroy(void *payload) {}
...
unsigned tree_sitter_luax_external_scanner_serialize(void *payload,
                                                     char *buffer) {
...
void tree_sitter_luax_external_scanner_deserialize(void *payload,
                                                   const char *buffer,
                                                   unsigned length) {
  if (length == 0)
    return;
...
bool tree_sitter_luax_external_scanner_scan(void *payload, TSLexer *lexer,
